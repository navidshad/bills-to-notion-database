...
class GoogleSheetsAdapter {
    ...
    async initializeSheets() {
        ...
        if (!this.spreadsheetId) {
            throw new Error("GOOGLE_SPREADSHEET_ID environment variable not set. Please provide an existing spreadsheet ID.");
        }
        try {
                                ...
                                rowCount: sheetName.startsWith("Bills_")
                                    ...
                                    : sheetName === "Categories"
                                        ...
                                        : sheetName === "TempBills"
                                            ? 100
                                            : 50,
                                columnCount: sheetName === "TempBills"
                                    ? 15
...
exports.default = new GoogleSheetsAdapter();
